cmdline="cmake \
  ...
  -D Netcdf_INCLUDE_DIRS:PATH='${TACC_PNETCDF_INC};${TACC_PARALLELNETCDF_INC}' \
  -D Netcdf_LIBRARY_DIRS:PATH='${TACC_PNETCDF_LIB};${TACC_PARALLELNETCDF_LIB}' \
  -D NOT_TPL_Netcdf_LIBRARIES='${TACC_PNETCDF_LIB}/libnetcdf.so;${TACC_PARALLELNETCDF_LIB}/libpnetcdf.so' \
  \
