cmdline="cmake \
  ...
  -D TPL_Netcdf_INCLUDE_DIRS:PATH=${TACC_PNETCDF_INC} \
  -D TPL_Netcdf_LIBRARY_DIRS:PATH=${TACC_PNETCDF_LIB} \
  -D TPL_Netcdf_LIBRARIES=${TACC_PNETCDF_LIB}/libpnetcdf.so \
  \
  ...
  -D NOT_TPL_Netcdf_LIBRARIES='${TACC_NETCDF_LIB}/libnetcdf.so;${TACC_PNETCDF_LIB}/libpnetcdf.so' \
  \
