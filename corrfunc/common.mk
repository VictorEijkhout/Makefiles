...
## VLE CFLAGS += -std=c99 -m64 -g -Wsign-compare -Wall -Wextra -Wshadow -Wunused -fPIC -D_POSIX_SOURCE=200809L -D_GNU_SOURCE -D_DARWIN_C_SOURCE -O3 #-Ofast
  CFLAGS += -std=c99 -g -Wsign-compare -Wall -Wextra -Wshadow -Wunused -fPIC -D_POSIX_SOURCE=200809L -D_GNU_SOURCE -O3 #-Ofast
    ...
    ifdef PYTHON_FOUND
      ...
      ifneq ($(COMPILE_PYTHON_EXT), 0)
        ...
        ifeq ($(NUMPY_CHECKED), 0)
          ...
          export NUMPY_INCL_FLAG2 := $(shell $(PYTHON) -c "from __future__ import print_function; import numpy; print('-isystem ' + numpy.__path__[0] + '/_core/include/' )" )
          ...
          ifeq (,$(wildcard ${NUMPY_NEEDED_HEADER_FILE}))
            $(error Required ${NUMPY_INCL_PATH} $(ccred)numpy headers$(ccreset) are missing...stopping the compilation. You might be able to fix this by installing $(ccblue)numpy-devel$(ccreset))
          endif
